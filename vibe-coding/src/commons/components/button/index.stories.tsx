...
const meta: Meta<typeof Button> = {
  ...
  parameters: {
    ...
    docs: {
      description: {
        component: '다양한 스타일과 상태를 지원하는 버튼 컴포넌트입니다. Primary, Secondary, Tertiary 변형과 Light/Dark 테마를 지원합니다.',
      },
    },
  },
  tags: ['autodocs'],
...
export const ButtonGroupVertical: Story = {
  render: () => (
    <ButtonGroup orientation="vertical" spacing="small">
      ...
      <Button variant="secondary" fullWidth>임시저장</Button>
      <Button variant="tertiary" fullWidth>취소</Button>
    </ButtonGroup>
  ),
};

export const ButtonGroupConnected: Story = {
  render: () => (
    <ButtonGroup orientation="horizontal" spacing="none">
      <Button variant="secondary">왼쪽</Button>
      <Button variant="secondary">중간</Button>
